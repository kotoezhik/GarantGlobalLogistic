...
$username = $_POST['name8'];   // сохраняем в переменную данные полученные из поля c именем
$usertel = $_POST['telephone8']; // сохраняем в переменную данные полученные из поля c телефонным номером
...
$msg .= "<h2 style='font-weight:bold;border-bottom:1px dotted #ccc;'>Cообщение с сайта (АВТО ЛАЙТ)</h2>\r\n";
