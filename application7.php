...
$username = $_POST['name7'];   // сохраняем в переменную данные полученные из поля c именем
$usertel = $_POST['telephone7']; // сохраняем в переменную данные полученные из поля c телефонным номером
...
$msg .= "<h2 style='font-weight:bold;border-bottom:1px dotted #ccc;'>Cообщение с сайта (АВИА ФРАХТ)</h2>\r\n";
