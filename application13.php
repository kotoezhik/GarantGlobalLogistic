...
$username = $_POST['name13'];   // сохраняем в переменную данные полученные из поля c именем
$usertel = $_POST['telephone13']; // сохраняем в переменную данные полученные из поля c телефонным номером
...
$msg .= "<h2 style='font-weight:bold;border-bottom:1px dotted #ccc;'>Cообщение с сайта (форма с футера)</h2>\r\n";
